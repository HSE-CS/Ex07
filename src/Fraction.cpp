...
{
	Fraction temp(this->numerator * c.denominator + this->denominator * c.numerator, c.denominator * this->denominator);
...
Fraction Fraction::operator*(const Fraction& c)
{
	Fraction temp(this->numerator * c.numerator, c.denominator * this->denominator);
	if (temp.denominator == 0)
	{
		throw;
	}
...
Fraction Fraction::operator/(const Fraction& c)
{
	Fraction temp(this->numerator * c.denominator, c.numerator * this->denominator);
	if (temp.denominator == 0)
	{
		throw;
	}
